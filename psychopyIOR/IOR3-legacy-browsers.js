...
function preCue_InstructionRoutineBegin(snapshot) {
  return async function () {
    ...
    preCue_InstructionComponents.forEach( function(thisComponent) {
...
function Pre_Practice_windowRoutineBegin(snapshot) {
  return async function () {
    ...
    Pre_Practice_windowComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function practice_trialsRoutineBegin(snapshot) {
  return async function () {
    ...
    practice_trialsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function practice_error_feedbackRoutineBegin(snapshot) {
  return async function () {
    ...
    practice_error_feedbackComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Pre_experiment_windowRoutineBegin(snapshot) {
  return async function () {
    ...
    Pre_experiment_windowComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function error_feedbackRoutineBegin(snapshot) {
  return async function () {
    ...
    error_feedbackComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
